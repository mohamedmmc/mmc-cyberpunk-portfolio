...
const MMC_XP = (() => {
  ...
  const CATALOG = [
    ...
    { id: "NIGHT_OWL",        hint: "Visit between 23:00 and 06:00", tier: "common" },
    ...
    { id: "DONUT_MASTER",     hint: "Meditate on the ASCII donut", tier: "common" },
    { id: "FRACTAL_EXPLORER", hint: "Dive 8 zooms into the Mandelbrot", tier: "rare" },
    { id: "GAME_OF_LIFE",     hint: "Watch Conway's Game of Life", tier: "common" },
    ...
    { id: "HACKERMAN",        hint: "Type 'hackerman' somewhere", tier: "rare" },
    { id: "WAKE_UP",          hint: "Type 'neo' somewhere",  tier: "common" },
    { id: "GEEK_CERTIFIED",   hint: "Type 'geek' somewhere", tier: "common" },
    { id: "GREETINGS_TN",     hint: "Type 'tunisia' somewhere", tier: "common" },
    { id: "CHAMELEON",        hint: "Click the hero badge 5 times", tier: "rare" },
    { id: "DEV_INSPECTOR",    hint: "Open the browser DevTools", tier: "common" },
    { id: "NOSY",             hint: "Right-click on the page", tier: "common" },
    { id: "LORE_KEEPER",      hint: "cat a hidden lore file in the terminal", tier: "rare" },
    { id: "HACKER",           hint: "Run 'hack' in the terminal", tier: "common" },
    { id: "SELF_DESTRUCTED",  hint: "Triple-click a danger zone", tier: "rare" },
    { id: "NEVER_GONNA",      hint: "Run 'rickroll' in the terminal", tier: "common" },
    { id: "BG_SWITCHER",      hint: "Use 'bg <name>' in the terminal", tier: "rare" },
    { id: "TILTED",           hint: "Enable gyroscope in cyberspace (mobile)", tier: "rare" }
  ];
